        ...
        <header class="header">
            <div class="container">
                ...
                <div class="right">
                    ...
                    <button class="btn" id="button1">Login</button>
                    <button class="btn" id="button2">Register</button>
    ...
    <div class="Container4">
      <div class="Con1">
        <div class="boxModel" id="boxModel1">
            ...
            <div>
                <img class="Simg" src="./Image/femalemodel.jpg" height="550px" width="400px" >
            </div>
        </div>
        <div class="boxModel" id="boxModel2">
            ...
            <button class="Sbtn">EXPLORE PROFILE</button>
            <div>
                <img class="Simg" src="./Image/malemodel.jpeg" height="550px" width="400px">
            </div>
        </div>
      </div>
      <div class="Con2">
        <div class="boxModel" id="boxModel3">
            ...
            <button class="Sbtn">EXPLORE PROFILE</button>
            <div>
                <img class="Simg" src="./Image/celebrities.jpeg" height="550px" width="400px">
            </div>
        </div>
        <div class="boxModel" id="boxModel4">
            ...
            <button class="Sbtn">EXPLORE PROFILE</button>
            <div>
                <img class="Simg" src="./Image/kidsmodels.jpeg" height="550px" width="400px">
            </div>
        </div>
...
<section class="Services">
    ...
    <div class="Container5">
        <div class="box" id="box1">PROMOTIONAL MODELS</div>
        <div class="box" id="box2">BRAND AMBASSADORS</div>
        <div class="box">EVENT MANAGEMENT</div>
        <div class="box">STUDIO RENTALS</div>
        <div class="box">PHOTOGRAPHY MODELS</div>
        <div class="box">RUNWAY MODELS</div>
        <div class="box" id="box7">TELEVISION MODELS</div>
        <div class="box" id="box8">MARKETING</div>
    </div>
</section>
...
<section class="Section6">
    ...
    <div class="AboutUs">
        ...
        <div class="AboutMore">
            <div class="div" id="div1">Over 20 yesr experience</div>
            <div class="div" id="div2">Professional advice</div>
            <div class="div" id="div3">The best model agency in the world</div>
        </div>
    </div>
</section>
